...
2. **Mandatory Schema Audit**: Before writing any `.sql` or python script that queries the database, you MUST consult `docs/database_schema.md` using `view_file` to verify the exact table relationships and columns. And always keep it up to date! 👩🏻‍🔬
