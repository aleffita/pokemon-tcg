...
- **Zero Polling Directive**: After launching background tasks (via run_command, manage_task, or schedule), NEVER loop or poll task status. The harness automatically notifies the agent upon task completion. Simply update the user and end the turn cleanly.
